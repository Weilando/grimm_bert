...
class TestClustering(TestCase):
    ...
    def test_extract_sub_matrix(self):
        ...
        indices = [2]
        matrix_exp = np.array([[9]])
        matrix_res = cl.extract_sub_matrix(distance_matrix, indices)
        np.testing.assert_array_equal(matrix_exp, matrix_res)
    ...
    def test_cluster_vectors_per_token(self):
        ...
        dictionary_res = cl.cluster_vectors_per_token(
